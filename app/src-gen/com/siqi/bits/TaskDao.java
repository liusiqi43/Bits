...
public class TaskDao extends AbstractDao<Task, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property FrequencyIntervalPair = new Property(12, String.class, "frequencyIntervalPair", false, "FREQUENCY_INTERVAL_PAIR");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TASK' (" + //
                ...
                "'FREQUENCY_INTERVAL_PAIR' TEXT NOT NULL ," + // 12: frequencyIntervalPair
                "'CATEGORY_ID' INTEGER NOT NULL );"); // 13: categoryId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Task entity) {
        ...
        stmt.bindString(13, entity.getFrequencyIntervalPair());
        stmt.bindLong(14, entity.getCategoryId());
    }
    ...
    public Task readEntity(Cursor cursor, int offset) {
        Task entity = new Task( //
            ...
            cursor.getString(offset + 12), // frequencyIntervalPair
            cursor.getLong(offset + 13) // categoryId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Task entity, int offset) {
        ...
        entity.setFrequencyIntervalPair(cursor.getString(offset + 12));
        entity.setCategoryId(cursor.getLong(offset + 13));
     }
