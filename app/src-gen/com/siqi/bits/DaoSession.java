...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        actionRecordDaoConfig = daoConfigMap.get(ActionRecordDao.class).clone();
        actionRecordDaoConfig.initIdentityScope(type);

        taskDao = new TaskDao(taskDaoConfig, this);
        categoryDao = new CategoryDao(categoryDaoConfig, this);
        actionRecordDao = new ActionRecordDao(actionRecordDaoConfig, this);

        registerDao(Task.class, taskDao);
        registerDao(Category.class, categoryDao);
        registerDao(ActionRecord.class, actionRecordDao);
    }
    
    public void clear() {
        taskDaoConfig.getIdentityScope().clear();
        categoryDaoConfig.getIdentityScope().clear();
        actionRecordDaoConfig.getIdentityScope().clear();
    }
