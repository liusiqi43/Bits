...
public class InAppPurchaseActivity extends ActionBarActivity {
  ...
  public static final String SKU_ACTIVE_TASKS_COUNT_LIMIT_UNLOCK =
      "active_tasks_count_limit_unlock";
    ...
    Utils.setupIabHelper(this, new IabSetupActionHandler() {
      ...
      public void onSetupDone() {
        if (Utils.mIabHelper != null && Utils.mIabHelper.isSetUpDone()) {
          ...
          Utils.mIabHelper.queryInventoryAsync(true, additionalSkuList,
              new IabHelper.QueryInventoryFinishedListener() {
            public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
              if (inventory == null || inventory.getSkuDetails
                  (SKU_ACTIVE_TASKS_COUNT_LIMIT_UNLOCK) == null) {
                Log.d(TAG, "inventory == null || inventory.getSkuDetails" +
                    "(SKU_ACTIVE_TASKS_COUNT_LIMIT_UNLOCK) == null");
  ...
  private void buildUpgradeChoiceDialog() {
    ...
    builder.setPositiveButton(R.string.buy_me_a_coffee, new DialogInterface.OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, int i) {
        ...
        Utils.mIabHelper.launchPurchaseFlow(InAppPurchaseActivity.this,
            SKU_ACTIVE_TASKS_COUNT_LIMIT_UNLOCK, 647, new IabHelper.OnIabPurchaseFinishedListener
                () {
          @Override
